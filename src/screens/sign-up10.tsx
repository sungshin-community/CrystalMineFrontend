...
export default function SignUp10() {
    return (
        <ThemeProvider theme={theme}>
            <Container>
            <SafeAreaView>
                <BigOneLineText style={styles.text}>정회원 인증을{"\n"}이어서 진행하시겠어요?</BigOneLineText>
                <Description style={[styles.text, styles.textDescription]}>가입 후 24시간 이내에 인증하지 않을 시{"\n"}
            ...
            <TouchableOpacity style={[styles.buttonNow, styles.buttonLater]}>
                <Text style={[styles.buttonNowText, styles.buttonLaterText]}>나중에 인증하기</Text>
            </TouchableOpacity>
            </Container>
        </ThemeProvider>
    )
