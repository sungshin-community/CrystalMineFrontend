  ...
  return (
    <TouchableOpacity
      ...
      <View
        ...
        <Text style={[fontRegular, {color: '#87919B', marginLeft: 8}]}>
          {comment.boardName}
        </Text>
        {deleteMode && (
          <View
      ...
      <View style={{paddingHorizontal: 10}}>
        ...
        <Text
          style={[
            {color: '#A0A8B0', fontSize: 13, marginBottom: 16, marginRight: 10},
            fontRegular,
          ]}
          numberOfLines={1}
          ellipsizeMode="tail">
          {(comment.isPostDeleted ? '' : '게시글 내용: ') + comment.postContent}
        </Text>
      </View>
    </TouchableOpacity>
  );
